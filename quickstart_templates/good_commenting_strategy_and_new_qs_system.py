...
# get a session!
session = InstaPy(username="xxxx", password="xxxx", headless_browser=True)
...
with smart_run(session):
    ...
    session.set_comments(
        [
            ...
            u"This is awesome!! :heart_eyes: Any feedback " u"for my photos? :wink:",
            ...
            u"Great capture!! :smiley: Any feedback for my " u"recent shot? :wink:",
